...
K.extend(KSWFUpload, {
	init : function(options) {
		...
		self.div = K(options.container).html([
			...
			'</select>',
			'&nbsp;宽度&nbsp;<input type="text" class="ke-input-text ke-input-number" id="thumbwidth" name="thumbwidth" value="" maxlength="4" /> ',
			'高度&nbsp;<input type="text" class="ke-input-text ke-input-number" id="thumbheight" name="thumbheight" value="" maxlength="4" /> ',
			'<select name="thumbsys" id="thumbsys">',
			'<option value="1" >使用预设缩图大小</option>',
			'<option value="0" >自定义缩图大小</option>',
			'</select>',
			'</div>',
		...
		K('.ke-swfupload-startupload input', self.div).click(function() {
			...
			self.swfu.addPostParam('thumbsys',K('#thumbsys', self.div).val());
